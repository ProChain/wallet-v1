...
export const WECHAT_APPID = 'wx48f51627bef8bcdf';
// export const WECHAT_APPID = 'wx6682dbc3bd52949e' // test
export const REDIRECT_URI = 'https://prabox.net/wallet-v1';
...
export async function uploadImg(data) {
    ...
    // return axios.post(apiUploadImg, {
    //   file
    // })
}
